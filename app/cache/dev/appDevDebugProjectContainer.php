...
class appDevDebugProjectContainer extends Container
{
    private static $parameters = array(
            'kernel.root_dir' => '/home/studenci/r12/s175423/public_html/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/home/studenci/r12/s175423/public_html/app/cache/dev',
            'kernel.logs_dir' => '/home/studenci/r12/s175423/public_html/app/logs',
            'kernel.bundles' => array(
                ...
                's175423Bundle' => 's175423\\Bundle\\s175423Bundle',
                'BartekHelloBundle' => 'Bartek\\HelloBundle\\BartekHelloBundle',
                'MickiewiczTadeuczBundle' => 'Mickiewicz\\TadeuczBundle\\MickiewiczTadeuczBundle',
                'PracazaliczeniowaBundle' => 'Praca\\zaliczeniowaBundle\\PracazaliczeniowaBundle',
            ...
            'database_host' => '10.254.94.2',
            'database_port' => NULL,
            'database_name' => 's175423',
            'database_user' => 's175423',
            'database_password' => 'fVLAgPd4',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'locale' => 'pl',
            'secret' => '4895366b4d472f7598696748b23c29034a670804',
            ...
            'kernel.secret' => '4895366b4d472f7598696748b23c29034a670804',
            ...
            'session.save_path' => '/home/studenci/r12/s175423/public_html/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:/home/studenci/r12/s175423/public_html/app/cache/dev/profiler',
            ...
            'router.resource' => '/home/studenci/r12/s175423/public_html/app/cache/dev/assetic/routing.yml',
            ...
            'debug.container.dump' => '/home/studenci/r12/s175423/public_html/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/home/studenci/r12/s175423/public_html/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => '/home/studenci/r12/s175423/public_html/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/home/studenci/r12/s175423/public_html/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/home/studenci/r12/s175423/public_html/app/../web',
            'assetic.write_to' => '/home/studenci/r12/s175423/public_html/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/home/studenci/r12/s175423/public_html/app/cache/dev/doctrine/orm/Proxies',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/home/studenci/r12/s175423/public_html/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig'), $this->get('monolog.logger.assetic', ContainerInterface::NULL_ON_INVALID_REFERENCE)), new \Assetic\Cache\ConfigCache('/home/studenci/r12/s175423/public_html/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '/home/studenci/r12/s175423/public_html/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/home/studenci/r12/s175423/public_html/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '10.254.94.2', 'port' => NULL, 'dbname' => 's175423', 'user' => 's175423', 'password' => 'fVLAgPd4', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/home/studenci/r12/s175423/public_html/src/Mickiewicz/TadeuczBundle/Entity')), 'Mickiewicz\\TadeuczBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('MickiewiczTadeuczBundle' => 'Mickiewicz\\TadeuczBundle\\Entity'));
        ...
        $b->setProxyDir('/home/studenci/r12/s175423/public_html/app/cache/dev/doctrine/orm/Proxies');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_d94648ab1c6ae9738ea17bd607d01dae4ded84ab0b2268de038db8d33ca82bb6');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/home/studenci/r12/s175423/public_html/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/home/studenci/r12/s175423/public_html/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/home/studenci/r12/s175423/public_html/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/home/studenci/r12/s175423/public_html/app/cache/dev/assetic/routing.yml', array('cache_dir' => '/home/studenci/r12/s175423/public_html/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true, 'resource_type' => 'yaml'), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/home/studenci/r12/s175423/public_html/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['sensio_distribution.webconfigurator'] = $instance = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/home/studenci/r12/s175423/public_html/app');
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/home/studenci/r12/s175423/public_html/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/home/studenci/r12/s175423/public_html/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/home/studenci/r12/s175423/public_html/app/cache/dev/translations', 'debug' => true));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/home/studenci/r12/s175423/public_html/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/home/studenci/r12/s175423/public_html/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/home/studenci/r12/s175423/public_html/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/home/studenci/r12/s175423/public_html/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/home/studenci/r12/s175423/public_html/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/home/studenci/r12/s175423/public_html/vendor/doctrine/doctrine-bundle/Resources/views', 'Doctrine');
        $instance->addPath('/home/studenci/r12/s175423/public_html/src/s175423/Bundle/Resources/views', 's175423');
        $instance->addPath('/home/studenci/r12/s175423/public_html/src/Bartek/HelloBundle/Resources/views', 'BartekHello');
        $instance->addPath('/home/studenci/r12/s175423/public_html/src/Mickiewicz/TadeuczBundle/Resources/views', 'MickiewiczTadeucz');
        $instance->addPath('/home/studenci/r12/s175423/public_html/src/Praca/zaliczeniowaBundle/Resources/views', 'Pracazaliczeniowa');
        $instance->addPath('/home/studenci/r12/s175423/public_html/vendor/symfony/symfony/src/Symfony/Bundle/DebugBundle/Resources/views', 'Debug');
        $instance->addPath('/home/studenci/r12/s175423/public_html/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/home/studenci/r12/s175423/public_html/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('/home/studenci/r12/s175423/public_html/app/Resources/views');
        $instance->addPath('/home/studenci/r12/s175423/public_html/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('4895366b4d472f7598696748b23c29034a670804');
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => '/home/studenci/r12/s175423/public_html/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/home/studenci/r12/s175423/public_html/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/home/studenci/r12/s175423/public_html/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/home/studenci/r12/s175423/public_html/app/cache/dev');
    }
